    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <div class="top-menu" style="align-content: center;text-align: center;">
            <div class="title" style="font-family: monospace; font-size: 36px;display:inline;align-content: center;text-align: center;cursor: pointer;"><a href="/chilli-bean-stir-fry?servings=${param.servings}&units=${param.units}" style="text-decoration: none; color: black;opacity: 0.8;padding-top: 5px;">Chilli bean stir fry</a></div>
        </div>
...
<!--SIDENAV---->
    <head>
          ...
          <div class="row">
            <div class="column" style="background-color:rgb(255, 255, 255);">
              ...
              <div id="OrangeBorder" style="width: 100%;align-content: center; font-size: 16px;" >
                <p>CHILLI BEAN STIR FRY</p>
              <p>4.5 Star Recipe</p>
              <p>By Dr Rupy Aujla</p>
            </div>
        ...
        <div style="width: 100%; text-align:center">
            <img src="https://food-images.files.bbci.co.uk/food/recipes/chilli_bean_stir-fry_19412_16x9.jpg" style="width:50%; margin: 60px -10px;">
        </div>
...
<div class="a">
  <br><br><p style="text-align: left;"><form action="/chilli-bean-stir-fry" method="get"><h3>Serves: ${choice1}</h3>
    ...
    <ul style="font-size: 16px;">
      <li>${ing_1} wholewheat noodles</li>
      <li>1 red chilli, roughly chopped</li>
      <li>${ing_2} piece root ginger, roughly chopped</li>
      <li>${a} garlic cloves</li>
      <li>${b} tbsp white vinegar</li>
      <li>${c} tsp brown sugar</li>
      <li>${d} tsp sesame oil</li>
      <li>${e} tbsp olive oil</li>
      <li>${ing_3} green beans, trimmed and halved</li>
      <li>${ing_4} broccoli, broken into small florets, thinly sliced stalks</li>
      <li>${f}, thinly sliced</li>
      <li>${ing_5} tin black beans, drained</li>
    </ul>
    <br><br><h3 style="font-size: 24px;font-weight: 100;text-decoration-line: underline;">Instructions</h3>
    <ol style="font-size: 16px;">
      <li>Bring a saucepan of water to the boil, add the noodles and cook for 4 minutes or until cooked. Drain, rinse under cold water and set aside.</li>
      <li>Put the chilli, ginger and garlic into a jug with the soy sauce, vinegar, sugar and sesame oil. Blend until smooth with a stick blender, then set aside. If you don’t have a stick blender, you can pound the ingredients together with a pestle and mortar.</li>
      <li>Heat the olive oil in a wok or large frying pan over a high heat, then add the green beans, broccoli and onion. Stir-fry for 2–3 minutes, until the beans and onions are lightly charred.</li>
    ...
    <a href="/downloads/chilli-bean-stir-fry.pdf" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.pdf)</button></a>
</div>
