    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <div class="top-menu" style="align-content: center;text-align: center;">
            <div class="title" style="font-family: monospace; font-size: 36px;display:inline;align-content: center;text-align: center;cursor: pointer;"><a href="/chilli-con-carne?servings=${param.servings}&units=${param.units}" style="text-decoration: none; color: black;opacity: 0.8;padding-top: 5px;">Chilli con carne</a></div>
        </div>
...
<!--SIDENAV---->
    <head>
        ...
        <div style="width: 100%; text-align:center">
            <img src="https://ichef.bbci.co.uk/food/ic/food_16x9_1600/recipes/healthy_chilli_con_carne_64911_16x9.jpg" style="width:80%; margin: 60px -10px;">
        </div>
...
<div class="a">
  ...
  <br><br><h3 style="font-size: 24px;font-weight: 100;text-decoration-line: underline;">Ingredients</h3>
    <ul style="font-size: 16px;">
        <li>Oil Spray</li>
        <li>${ing_1} lean minced beef</li>
        <li>${a}, finely chopped</li>
        <li>${b} tsp finely grated garlic</li>
        <li>1 courgette, cut into 1cm or &#189;in pieces</li>
        <li>1 aubergine, cut into 1cm or &#189;in pieces</li>
        <li>${c}, deseeded and chopped into 1cm or &#189;in pieces</li>
        <li>${d} tsp ground cumin</li>
        <li>${e} tsp sweet smoked paprika</li>
        <li>&#189; tsp gound cinnamon</li>
        <li>${f} tsp hot chilli powder</li>
    ...
    <ol style="font-size: 16px;">
        <li>Use oil spray on large frying pan. Add the minced beef and stir-fry over a high heat for 5-6 minutes/until lightly brown.</li>
        <li>Add onion, garlic, courgette, aubergine, and red pepper to the frying pan and stiry fry for another 3-4 minutes. Add cumin, paprika, cinammon and chilli powder and stir-fry for 1-2 minutes.</li>
        <li>Add kidney beans, tomatoes, tomato pur&eacute;e, beef stock and season well with salt and pepper. Bring to a boil, then reduce the heat to a simmer, cover and cook for 20-25 minutes, stir occasionally.</li>
        <li>Uncover, stir and cook over a medium heat for 10 minutes.</li>
        <li>Whilst cooking, cook the rice according to the instructions on the packet.</li>
    ...
    <a href="/downloads/chilli-con-carne.pdf" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.pdf)</button></a>
</div>
