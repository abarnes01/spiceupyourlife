    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <div class="top-menu" style="align-content: center;text-align: center;">
            <div class="title" style="font-family: monospace; font-size: 36px;display:inline;align-content: center;text-align: center;cursor: pointer;"><a href="/moroccan-style-soup?servings=${param.servings}&units=${param.units}" style="text-decoration: none; color: black;opacity: 0.8;padding-top: 5px;">Moroccan style soup</a></div>
        </div>
...
<!----MAINRECIPE----->
        ...
        <div class="a">
          <br><br><p style="text-align: left;"><form action="/moroccan-style-soup" method="get"><h3>Serves: ${choice1}</h3>
          <br>Change to: 
          ...
          <ol style="font-size: 16px;">
            ...
            <br>
            <a href="/moroccan-style-soup?servings=${param.servings}&units=${param.units}" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.html)</button></a>
            <a href="/downloads/moroccan-style-soup.txt" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.txt)</button></a>
            <a href="/downloads/moroccan-style-soup.pdf" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.pdf)</button></a>
        </div>
