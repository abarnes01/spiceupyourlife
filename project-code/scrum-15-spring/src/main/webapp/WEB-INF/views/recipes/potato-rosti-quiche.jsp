    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <div class="top-menu" style="align-content: center;text-align: center;">
            <div class="title" style="font-family: monospace; font-size: 36px;display:inline;align-content: center;text-align: center;cursor: pointer;"><a href="/potato-rosti-quiche?servings=${param.servings}&units=${param.units}" style="text-decoration: none; color: black;opacity: 0.8;padding-top: 5px;">Potato rosti quiche</a></div>
        </div>
...
<!--SIDENAV---->
    <head>
          ...
          <div class="row">
            <div class="column" style="background-color:rgb(255, 255, 255);">
              ...
              <div id="OrangeBorder" style="width: 100%;align-content: center; font-size: 16px;" >
                <p>POTATO-ROSTI-QUICHE</p>
              <p>4.5 Star Recipe</p>
              <p>By Nadiya Hussain </p>
            </div>
        ...
        <div style="width: 100%; text-align:center">
            <img src="https://ichef.bbci.co.uk/food/ic/food_16x9_1600/recipes/potato_rosti_quiche_87900_16x9.jpg" style="width:80%; margin: 60px -10px;">
        </div>
...
<div class="a">
  <br><br><p style="text-align: left;"><form action="/potato-rosti-quiche" method="get"><h3>Serves: ${choice1}</h3>
      <br>Change to: 
  ...
  <br><p style="font-size: 18px;font-weight: 600;">For the Base:</p>
  <ul style="font-size: 16px;">
      <li>butter or oil, for greasing</li>
      <li>1${a}potato (about ${ing_1}), unpeeled and scrubbed</li>
      <li>1${a}sweet potato (about ${ing_1}), unpeeled and scrubbed</li>
      <li>${b} tsp salt</li>
      <li>${b} tsp paprika</li>
      <li>${b} tsp garlic granules</li>
      <li>${b} tbsp onion granules</li>
      <li>${ing_2} plain flour</li>
      <li>1 free-range egg, plus 1 free-range egg, beaten, for brushing</li>
  </ul>
  <br><p style="font-size: 18px;font-weight: 600;">For the Filling:</p>
  <ul style="font-size: 16px;">
      <li>3 free-range eggs</li>
      <li>${c}ml full-fat milk</li>
      <li>${ing_3} mature cheddar, grated</li>
      <li>small handful fresh chives, snipped</li>
  ...
  <ol style="font-size: 16px;">
      ...
      <li>Leave to cool for about 30 minutes to allow the eggy custard filling to set. Slice and serve immediately.</li>
  </ol>
  <br>
  <a href="/potato-rosti-quiche?servings=${param.servings}&units=${param.units}" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.html)</button></a>
  <a href="/downloads/potato-rosti-quiche.txt" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.txt)</button></a>
  <a href="/downloads/potato-rosti-quiche.pdf" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.pdf)</button></a>
</div>
