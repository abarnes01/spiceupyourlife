...
<div class="a">
  <br><br><p style="text-align: left;"><form action="potato-rosti-quiche.html" method="get"><h3>Serves: ${choice1}</h3>
      <br>Change to: 
  ...
  <br>
  <a href="/project-code/scrum-15-spring/src/main/webapp/WEB-INF/views/recipes/potato-rosti-quiche.html" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.html)</button></a>
  <a href="/project-code/scrum-15-spring/src/main/webapp/WEB-INF/views/recipes/potato-rosti-quiche.txt" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.txt)</button></a>
</div>
