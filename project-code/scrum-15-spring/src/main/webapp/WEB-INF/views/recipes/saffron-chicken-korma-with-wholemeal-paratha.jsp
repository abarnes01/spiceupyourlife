...
<div class="a">
  ...
  <ol style="font-size: 16px;">
    ...
    <br>
    <a href="/project-code/scrum-15-spring/src/main/webapp/WEB-INF/views/recipes/saffron-chicken-korma-with-wholemeal-paratha.html" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.html)</button></a>
    <a href="/project-code/scrum-15-spring/src/main/webapp/WEB-INF/views/recipes/saffron-chicken-korma-with-wholemeal-paratha.txt" download><button class="btn" style="width: 150px;"><i class="fa fa-download"></i> Download Recipe (.txt)</button></a>
</div>
