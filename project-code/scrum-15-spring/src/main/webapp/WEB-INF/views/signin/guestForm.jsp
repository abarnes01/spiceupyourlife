    ...
    <body>
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <div class="top-menu" style="align-content: center;text-align: center;">
            <div class="title" style="font-family: monospace; font-size: 36px;display:inline;align-content: center;text-align: center;cursor: pointer;"><a href="index.html" style="text-decoration: none; color: black;opacity: 0.8;padding-top: 5px;">Continue as Guest</a></div>
        </div>
    </body>
...
<!--SIDENAV---->
    ...
    <div style="float: left;width: 100%;text-align: center;padding-right: 10%; ">
      <form:form action="/addCustomer" modelAttribute="newAcc" method="POST" class="guest-form" style="display: inline; color: black ">
