  ...
  <option value="1.5">Packet(100g)</option>
	...
	<div class="cart">
		<form action="spiceDetails" id="spice" name="spice" method="get">
			<input type="hidden" value="cinnamon" name="spice" id="spice"/>
	...
	<div class="product">
		<div class="image"><img src="https://post.healthline.com/wp-content/uploads/2020/09/health-benefits-cinnamon-fb-1200x628.jpg" style="width: 600px; height: 500px; float: left;margin-bottom: px;"></div>	 
	</div>
